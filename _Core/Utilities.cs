...
{
    public static bool TryGet<T>(this Node node, out T target) where T : class
    {
        if (node is T value)
        {
            target = value;
    ...
    public static bool TryGet<T1, T2>(this Node node, out T1 t1, out T2 t2)
    where T1 : class where T2 : class
    => TryGet(node, out t1) & TryGet(node, out t2);

    public static bool TryGet<T1, T2, T3>(this Node node, out T1 t1, out T2 t2, out T3 t3)
    where T1 : class where T2 : class where T3 : class
    => TryGet(node, out t1) & TryGet(node, out t2) & TryGet(node, out t3);

    public static bool TryGet<T1, T2, T3, T4>(this Node node, out T1 t1, out T2 t2, out T3 t3, out T4 t4)
    where T1 : class where T2 : class where T3 : class where T4: class
    => TryGet(node, out t1) & TryGet(node, out t2) & TryGet(node, out t3) & TryGet(node, out t4);
    ...
    public static bool TryLoadAsChild(this Node parent, Node node, string path)
    {
